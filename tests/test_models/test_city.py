...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_instantiation_with_kwargs(self):
        ...
        cty = City(id="66566", created_at=d_t_iso, updated_at=d_t_iso)
        self.assertEqual(cty.id, "66566")
        self.assertEqual(cty.created_at, d_t)
        self.assertEqual(cty.updated_at, d_t)
