...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_instantiation_with_kwargs(self):
        ...
        plc = Place(id="66566", created_at=d_t_iso, updated_at=d_t_iso)
        self.assertEqual(plc.id, "66566")
        self.assertEqual(plc.created_at, d_t)
        self.assertEqual(plc.updated_at, d_t)
