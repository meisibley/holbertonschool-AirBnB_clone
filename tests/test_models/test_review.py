...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_instantiation_with_kwargs(self):
        ...
        rev = Review(id="66566", created_at=d_t_iso, updated_at=d_t_iso)
        self.assertEqual(rev.id, "66566")
        self.assertEqual(rev.created_at, d_t)
        self.assertEqual(rev.updated_at, d_t)
