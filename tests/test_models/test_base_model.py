...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_instance_using_kwargs(self):
        d_t = datetime.now()
        d_t_iso = d_t.isoformat()
        base1 = BaseModel(id="12845", created_at=d_t_iso, updated_at=d_t_iso)
        self.assertEqual(base1.id, "12845")
    ...
    def test_both_args_and_kwargs(self):
        d_t = datetime.now()
        d_t_iso = d_t.isoformat()
        base1 = BaseModel("18", id="876", created_at=d_t_iso, updated_at=d_t_iso)
        self.assertEqual(base1.id, "876")
        self.assertEqual(base1.created_at, d_t)
        self.assertEqual(base1.updated_at, d_t)
