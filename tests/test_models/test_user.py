...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_instantiation_with_kwargs(self):
        ...
        usr = User(id="66566", created_at=d_t_iso, updated_at=d_t_iso)
        self.assertEqual(usr.id, "66566")
        self.assertEqual(usr.created_at, d_t)
        self.assertEqual(usr.updated_at, d_t)
